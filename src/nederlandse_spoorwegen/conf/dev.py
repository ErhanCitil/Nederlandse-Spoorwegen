...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-svop&2)6grnk6_mudmrl(l0q!&9n0qf3c#6a$ntlzz1r)1)gxs",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "nederlandse_spoorwegen")
os.environ.setdefault("DB_USER", "nederlandse_spoorwegen")
os.environ.setdefault("DB_PASSWORD", "nederlandse_spoorwegen")
