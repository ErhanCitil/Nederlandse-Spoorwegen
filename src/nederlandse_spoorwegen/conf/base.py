...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "nederlandse_spoorwegen"),
        "USER": config("DB_USER", "nederlandse_spoorwegen"),
        "PASSWORD": config("DB_PASSWORD", "nederlandse_spoorwegen"),
...
INSTALLED_APPS = [
    ...
    "nederlandse_spoorwegen.accounts",
    "nederlandse_spoorwegen.utils",
]
...
ROOT_URLCONF = "nederlandse_spoorwegen.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "nederlandse_spoorwegen.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "nederlandse_spoorwegen.wsgi.application"
...
DEFAULT_FROM_EMAIL = "nederlandse_spoorwegen@example.com"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOGGING_DIR / "nederlandse_spoorwegen.log",
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "nederlandse_spoorwegen.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "nederlandse_spoorwegen_sessionid"
...
CSRF_FAILURE_VIEW = "nederlandse_spoorwegen.accounts.views.csrf_failure"
...
# Custom settings
#
PROJECT_NAME = "nederlandse_spoorwegen"
...
ADMIN_INDEX_DISPLAY_DROP_DOWN_MENU_CONDITION_FUNCTION = (
    "nederlandse_spoorwegen.utils.django_two_factor_auth.should_display_dropdown_menu"
)
...
ELASTIC_APM = {
    "SERVICE_NAME": f"nederlandse_spoorwegen {ENVIRONMENT}",
